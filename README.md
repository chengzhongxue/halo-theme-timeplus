...
[Halo-Theme-TimePlus](https://githubfast.com/chengzhongxue/halo-theme-timeplus)
是一款适用于 [Halo2.x](https://githubfast.com/halo-dev/halo) 的博客主题。

移植自 [Typecho](https://typecho.org/) 社区中 
的 [TimePlus](https://githubfast.com/zhheo/TimePlus) 主题，作者是 [张洪Heo](https://githubfast.com/zhheo)
...
1. **本主题依赖图库插件**
2. 如果安装主题后报错，请仔细查阅[主题说明](https://githubfast.com/chengzhongxue/halo-theme-timeplus)
   与[更新说明](https://githubfast.com/chengzhongxue/halo-theme-timeplus/releases)！！！
3. 如果还未解决，可以加群求助！！！
...
1. 在 [ Release](https://githubfast.com/chengzhongxue/halo-theme-timeplus/releases) 页面 `下载` 最新主题包 (zip)
...
1. 复制地址 `https://githubfast.com/chengzhongxue/halo-theme-timeplus`
...
- 图库插件 [plugin-photos](https://githubfast.com/halo-sigs/plugin-photos/releases)


## 📝 使用

[文档](https://timeplus.yyds.pink/)

## 🔐 许可

[Halo-Theme-TimePlus](https://githubfast.com/chengzhongxue/halo-theme-timeplus) 使用 [MIT](./LICENSE) 协议开源，请遵守开源协议。
