    ...
    e.fn.poptrox_disableSelection = function() {
        ...
        e.fn.poptrox = function(o) {
            ...
            var p, i, s = e.extend({
                ...
                onPopupClose: null,
                onPopupOpen: null
            }, o), r = e(this), n = e("body"), a = e('<div class="' + s.overlayClass + '"></div>'), l = e(window), u = [], d = 0, h = !1, g = new Array, f = function() {
                p = l.width(),
            ...
            s.usePopupNav || (s.popupNavPreviousSelector = null,
            ...
            var v = x.find(".pic")
                ...
                , P = y.add(S);
            if (s.usePopupDefaultStyling && (x.css("background", s.popupBackgroundColor).css("color", s.popupTextColor).css("padding", s.popupPadding + "px"),
            m.length > 0 && (x.css("padding-bottom", s.popupCaptionHeight + "px"),
                m.css("position", "absolute").css("left", "0").css("bottom", "0").css("width", "100%").css("text-align", "center").css("height", s.popupCaptionHeight + "px").css("line-height", s.popupCaptionHeight + "px"),
            s.popupCaptionTextSize && m.css("font-size", popupCaptionTextSize)),
            C.length > 0 && C.html(s.popupCloserText).css("font-size", s.popupCloserTextSize).css("background", s.popupCloserBackgroundColor).css("color", s.popupCloserTextColor).css("display", "block").css("width", "40px").css("height", "40px").css("line-height", "40px").css("text-align", "center").css("position", "absolute").css("text-decoration", "none").css("outline", "0").css("top", "0").css("right", "-40px"),
            b.length > 0 && b.html("").css("position", "relative").css("font-size", s.popupLoaderTextSize).on("startSpinning", function(o) {
            ...
            return l.on("resize orientationchange", function() {
                ...
                x.css("display", "inline-block").css("vertical-align", "middle").css("position", "relative").css("z-index", 1).css("cursor", "auto").appendTo(a).hide().on("poptrox_next", function() {
                    ...
                    w.attr("src") && w.attr("src", ""),
                        ...
                        "ajax" == i.type ? e.get(i.src, function(e) {
                            w.html(e),
                                w.trigger("load")
                        }) : w.attr("src", i.src),
                    "image" != i.type) {
                    ...
                    b.trigger("startSpinning").fadeIn(300),
                        x.show(),
                        s.popupIsFixed ? (x.removeClass("loading").width(s.popupWidth).height(s.popupHeight),
                            w.on("load", function() {
                                w.off("load"),
                                    b.hide().trigger("stopSpinning"),
                                    m.trigger("update", [i.captionText]).fadeIn(s.fadeSpeed),
                                    C.fadeIn(s.fadeSpeed),
                                    v.css("text-indent", 0).hide().fadeIn(s.fadeSpeed, function() {
                                        h = !1
                                    }),
                                    d = t,
                    ...
                    return !(!h || s.usePopupForceClose) || (h = !0,
                ...
                s.usePopupEasyClose ? (m.on("click", "a", function(e) {
                    e.stopPropagation()
                }),
                ...
                l.keydown(function(e) {
                    if (x.is(":visible"))
                        switch (e.keyCode) {
                            ...
                            case 32:
                                if (s.usePopupNav)
                                    return x.trigger("poptrox_previous"),
                                        !1;
                                break;
                            case 39:
                                if (s.usePopupNav)
                                    return x.trigger("poptrox_next"),
                                        !1;
                                break;
                            case 27:
                ...
                r.find(s.selector).each(function(o) {
                    var t, p, i = e(this), r = i.find("img"), n = i.data("poptrox");
                    if ("ignore" != n && i.attr("href")) {
                        if (t = {
                            ...
                            s.caption) {
                            if ("function" == typeof s.caption)
                                c = s.caption(i);
                            else if ("selector"in s.caption) {
                                var a;
                                a = i.find(s.caption.selector),
                                    "attribute"in s.caption ? c = a.attr(s.caption.attribute) : (c = a.html(),
                                    s.caption.remove === !0 && a.remove())
                            }
                        } else
                            c = r.attr("title");
                        if (t.captionText = c,
                            ...
                            var l = n.split(",");
                            0 in l && (t.type = l[0]),
                            1 in l && (p = l[1].match(/([0-9%]+)x([0-9%]+)/),
                            p && 3 == p.length && (t.width = p[1],
                                t.height = p[2])),
                            2 in l && (t.options = l[2])
                        }
                        if (!t.type)
                            switch (p = t.src.match(/\/\/([a-z0-9\.]+)\/.*/),
                            (!p || p.length < 2) && (p = [!1]),
                                p[1]) {
                        ...
                        switch (p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/),
                            ...
                            case "iframe":
                                t.object = e('<iframe src="" frameborder="0"></iframe>'),
                                    t.object.on("click", function(e) {
                                        e.stopPropagation()
                                    }).css("cursor", "auto"),
                                t.width && t.height || (t.width = "600",
                                    t.height = "400");
                                break;
                            case "ajax":
                            ...
                            case "bcove":
                                ...
                                t.width && t.height || (t.width = "640",
                                    t.height = "360");
                                break;
                            default:
                                if (t.object = e('<img src="" alt="" style="vertical-align:bottom" />'),
                                    s.preload) {
                        ...
                        "file:" == window.location.protocol && t.src.match(/^\/\//) && (t.src = "http:" + t.src),
                            u.push(t),
                            r.removeAttr("title"),
                            i.removeAttr("href").css("cursor", "pointer").css("outline", 0).on("click", function(e) {
                                e.preventDefault(),
                                    e.stopPropagation(),
